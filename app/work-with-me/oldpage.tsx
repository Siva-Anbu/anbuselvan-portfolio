...
const services = [
  {
    ...
    description:
      'Soft, natural light. Calm, unhurried sessions. Maternity is one of the most intimate transitions in life — I aim to photograph it with the quiet reverence it deserves.',
  ...
  },
  {
    ...
    title: 'Couple Shoots',
    description:
      'Whether it's an anniversary, a pre-wedding session, or simply wanting beautiful photographs together — I create space for natural moments rather than forced poses.',
  ...
  },
  {
    ...
    description:
      'Candid, joyful, and atmospheric. I document the energy of birthdays — the small moments between the big ones that make for the most memorable photographs.',
  ...
  },
  {
    ...
    description:
      'Small gatherings, intimate ceremonies, family reunions. If it matters to you, it matters to me. I shoot quietly, move through spaces gently, and deliver work that endures.',
    ...
    <main className="min-h-screen">
      ...
      <div className="pt-32 md:pt-40 px-6 md:px-12 max-w-[1600px] mx-auto border-b border-white/5 pb-16">
        ...
        <p className="font-body text-sm text-white/40 mt-6 max-w-lg leading-relaxed">
          I'm at the intersection of passion and profession — someone who takes photographs seriously, but hasn't let that seriousness take the joy out of it.
        </p>
      </div>
      ...
      <div className="px-6 md:px-12 max-w-[1600px] mx-auto py-16">
        <div className="max-w-2xl">
          ...
          >
            "I photograph people the same way I photograph places — by waiting for the moment they forget I'm there."
          </blockquote>
        </div>
      </div>
      ...
      <div className="px-6 md:px-12 max-w-[1600px] mx-auto pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/5">
          {services.map((service) => (
            <div
              key={service.id}
              className="bg-[#0a0a0a] p-8 md:p-10 group hover:bg-white/[0.02] transition-colors duration-300"
            >
              {/* Number */}
              <span
                className="font-mono text-[11px] tracking-[0.3em] block mb-5"
              ...
              {/* Description */}
              <p className="font-body text-[13px] leading-[1.8] text-white/45 mb-6">
                {service.description}
              </p>
              ...
              <ul className="space-y-2">
                {service.details.map((detail) => (
                  <li
                    key={detail}
                    className="flex items-center gap-3 font-mono text-[9px] tracking-[0.2em] uppercase text-white/30"
                  >
      ...
      <div className="px-6 md:px-12 max-w-[1600px] mx-auto pb-24 border-t border-white/5 pt-16">
        <p className="font-mono text-[10px] tracking-[0.35em] uppercase text-white/25 mb-10">
          How It Works
        </p>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            { step: '01', title: 'Reach Out', desc: 'Drop me a message with the occasion, date, and what you have in mind.' },
            { step: '02', title: 'We Talk', desc: 'A short conversation to understand your vision and make sure we\'re a good fit.' },
            ...
            <div key={step}>
              <span
                className="font-mono text-[10px] tracking-[0.3em] block mb-3"
                style={{ color: 'var(--accent)' }}
              >
                {step}
              </span>
      ...
      <div className="border-t border-white/5 py-24 text-center px-6">
        <p className="font-display text-3xl md:text-5xl font-light text-white mb-4">
          Ready to collaborate?
        </p>
        <p className="font-body text-sm text-white/35 mb-10 max-w-sm mx-auto leading-relaxed">
          If you'd like to work together, feel free to reach out. No pressure, no packages to choose from right away — just a conversation.
        </p>
        <Link
          href="/contact"
