...
function buildImage(resource: any): CloudinaryImage {
  ...
  return {
    ...
    url: buildUrl(resource.public_id, "w_1200,q_85,f_auto,e_improve:40,e_sharpen:30/l_logo_sa,g_south_east,o_50,w_150"),
    heroUrl: buildUrl(resource.public_id, "w_1920,q_88,f_auto,e_improve:40,e_sharpen:30/l_logo_sa,g_south_east,o_50,w_200"),
